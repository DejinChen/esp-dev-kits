...
CustomFactoryDataProvider sFactoryDataProvider;
uint32_t CustomFactoryDataProvider::Passcode = 0;
char qrcode_data[chip::QRCodeBasicSetupPayloadGenerator::kMaxQRCodeBase38RepresentationLength + 1] = {0};
#else
char qrcode_data[] = "MT:U9VJ0EPJ01ZD6100000";
#endif
...
bool whether_wifi_connected()
{
    return wifi_connected;
}

bool whether_get_matter_fabric()
{
